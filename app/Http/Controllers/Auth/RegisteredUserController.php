...
class RegisteredUserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($user) {
            return redirect()->route('login')->with('success', 'Inscription bien éffectuée! Vous pouvez vous connecter maintenant.');
        }
    ...
    protected function utilisateurs()
    {
        #Tous les utilisateurs
        $utilisateurs = User::paginate('10');
        return view('/auth.users', compact('utilisateurs'));
    }
}
